...
function AdminOrderDetails(){
  ...
  <div className="flex justify-start item-start space-y-2 flex-col">
    <h1 className="text-3xl dark:text-gray lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">{orderId ? `Order #${orderId}` : "Loading order..."}</h1>
      ...
      <div className="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
        ...
        
        {
          ...
          <div className="pb-4 md:pb-8 w-full md:w-40">
            <img className="w-full hidden md:block" src={`http://localhost:4000/${od.product?.productImageUrl}`} alt="dress" />
          ...
          <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
            ...
            <div className="flex justify-between space-x-8 items-start w-full">
              <p className="text-base dark:text-white xl:text-lg leading-6">Rs {od.product?.productPrice} 
      ...
      <div className="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
        ...
        <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
          ...
          <div className="flex justify-between items-start w-full">
            ...
            <p className="text-lg font-semibold leading-6 dark:text-white text-gray-800">Rs. 120</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-col justify-start items-start flex-shrink-0">
          <div className="flex justify-center w-full md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
            <div className="flex justify-start items-start flex-col space-y-2">
              ...
              <p className="text-sm dark:text-gray-300 leading-5 text-gray-600">Phone Number: {orderDetails[0]?.order?.phoneNumber}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex w-full justify-center items-center md:justify-start md:items-start">
            {
              orderDetails[0]?.order?.orderStatus !== OrderStatus.Cancelled && (
                ...
                <select onChange={handleOrderStatusChange} name="" id="" className="">
                    <option></option>
